...
void fitGretinaPeaks(std::string data_file_name, std::string output_fn, std::string peak_input, std::string bg_line_input, 
  ...
  //GH1D* data_hist((GH1D*)data_file->Get("Gretina_incoming_timeEnergy/Gamma(Beta&AdjustedTrack&YTA&DTA)_p37"));
  ...
  const double NARROW_SCALE = 1.0;
  const double WIDE_SCALE = 0.0;
