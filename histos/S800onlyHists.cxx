...
bool HandleS800_Gated(TRuntimeObjects &obj,TCutG *incoming, TCutG* outgoing, TCutG* xToF) {
  ...
  ///////////////////////////////////////////////////////////////////
  if(outgoing) {
  //  if(!outgoing->IsInside(s800->GetOBJ_E1Raw(),s800->GetIonChamber().Charge()))
...
//Histogram Charge vs Tof
  ...
  obj.FillHistogram(dirname,Form("Charge_v_Obj-E1Corr%s",hsuf.c_str()),
		  1000,-2000,2000,s800->GetCorrTOF_OBJ(),
                  1000,0,30000,s800->GetIonChamber().Charge());
...
//  HandleS800_Gated(obj,incoming_cuts.at(0),outgoing_cuts.at(0),xToF_cuts.at(0));
